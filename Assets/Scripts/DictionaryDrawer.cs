...
[CustomPropertyDrawer(typeof(StringClipDict))]
public class StringClipDictDrawer : DictionaryDrawer<string, AudioClip> { }

public class StringClipDict : SerializedDictionary<string, AudioClip>
{
}
